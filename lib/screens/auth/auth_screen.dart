...
class _AuthScreenState extends State<AuthScreen> {
  ...
  bool isValidLoginCredentials ()=>AppConstants.passwordRegExp
      .hasMatch(passwordController.text) &&
      AppConstants.textRegExp.hasMatch(
                        ...
                        child: Column(
                          children: [
                            ...
                            MyCustomButton(onTap: () {
                              context.read<AuthBloc>().add(LoginUserEvent(password: passwordController.text, username: userNameController.text));
                            },
            ...
            listener: (context, state) {
              ...
              if (state.status == FormsStatus.authenticated){
                if (state.statusMessage == "registered") {
                  // state.userModel
                  // TODO User ma'lumotlari saqlansin
